...
def train():
    ...
    model = XGBClassifier(
        ...
        scale_pos_weight=1,   # bisa diubah kalau data imbalance
    ...
    with mlflow.start_run():
        ...
        precision, recall, f1, _ = precision_recall_fscore_support(
            y_test, y_pred, average="binary", pos_label="judi"
        )
        acc = accuracy_score(y_test, y_pred)
    ...
    print("Training finished. Metrics: precision=%.4f recall=%.4f f1=%.4f acc=%.4f" %
